...
class VIPTelegramAirdropCron extends Command {
     ...
     * @var string
     */
    protected $signature = 'datagamble:airdropcron';
    ...
    public function handle() {
        $cronenabled = floatval(Settings::where('name', 'tg_cron')->first()->value);
        if($cronenabled == '1') {
        ...
        $message = $bot->sendPhoto([
            'chat_id' => -1001199743876,
                ...
                'reply_markup' => [
                    'inline_keyboard' => [[[
                    'text' => 'Enter VIP DROPCODE @ BIGZ.IO',
            ...
            Settings::where('name', 'tg_cron')->update(['value' => 0]);
