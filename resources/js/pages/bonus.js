...
$.on('/bonus', function() {
    ...
    $('.bo1').on('click', function() {
            $.request('offers/bonus1').then(function() {
                ...
                if(error === 2) $.error($.lang('bonus.offers.oneactive'));
                if(error === 3) $.error($.lang('bonus.offers.lowviplevel'));
            });
        });
 ...
 $('#bo1-forfeit').on('click', function() {
    ...
    $('.bo2').on('click', function() {
            $.request('offers/bonus2').then(function() {
                $.success($.lang('bonus.offers.bonus1started'));
            }, function(error) {
                if(error === 1) $.error($.lang('bonus.offers.invalid'));
                if(error === 2) $.error($.lang('bonus.offers.oneactive'));
    ...
    $('.bo2-complete').on('click', function() {
            $.setCurrency('eth');
            $.request('offers/bonus2complete').then(function() {
                $.success($.lang('bonus.offers.bonnus1completed'));
            }, function(error) {
                if(error === 1) $.error($.lang('bonus.offers.invalid'));
            });
    ...
    $('.bo2-forfeit').on('click', function() {
            $.request('offers/bonus2forfeit').then(function() {
                $.success($.lang('bonus.offers.bonus1forfeit'));
            }, function(error) {
                if(error === 1) $.error($.lang('bonus.offers.invalid'));
            });
