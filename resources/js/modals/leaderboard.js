...
$.updateLeaderSelector = function() {
    const formatIcon = function(icon) {
        return $(`<span><img src="/img/currency/svg/${$(icon.element).data('icon')}.svg" style="width: 12px !important; height: 12px !important; margin-bottom: 2px !important;"> ${icon.text}</span>`)
    };
