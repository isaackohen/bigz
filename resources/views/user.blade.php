                                                ...
                                                <th>
                                                    <div>
                                                        <div class="icon d-none d-md-inline-block">
                                                                <img src="/img/currency/svg/{{ $currency->id() }}.svg" style="margin-top: 5px; width: 14px; height: 14px;">
                                                        </div>
                                                        <div class="name">
                                                ...
                                                <th data-highlight style="text-align: right">
                                                    <div>
                                                        <span>{{ number_format(floatval($wagered), 8, '.', '') }}</span>
                                                                <img src="/img/currency/svg/{{ $currency->id() }}.svg" style="margin-bottom: 5px; width: 14px; height: 14px;">
                                                    </div>
                                                </th>
                                                <th data-highlight>
                                                    <div>
