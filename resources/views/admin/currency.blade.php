                                  ...
                                  <div class="form-group mt-2">
                                    ...
                                    @php
                                        ...
                                        {{ number_format((\App\Http\Controllers\Api\WalletController::rateDollarLtc() * $getvalue), 3, '.', '') }}$
                                                                                @endif 
                                        @if($currency->id() == 'bnb')
                                        {{ number_format((\App\Http\Controllers\Api\WalletController::rateDollarBnb() * $getvalue), 3, '.', '') }}$
                                                                                @endif 

                                       @if($currency->id() == 'usdt')
                                        {{ number_format((\App\Http\Controllers\Api\WalletController::rateDollarUsdt() * $getvalue), 3, '.', '') }}$
                                                                                @endif 

                                        @if($currency->id() == 'usdc')
                                        {{ number_format((\App\Http\Controllers\Api\WalletController::rateDollarUsdc() * $getvalue), 3, '.', '') }}$
                                                                                @endif 

                                        @if($currency->id() == 'xrp')
                                        {{ number_format((\App\Http\Controllers\Api\WalletController::rateDollarXrp() * $getvalue), 3, '.', '') }}$
                                                                                @endif 
